...
const PARTICLES = [
  { r: 13, speed: 1.1, phase: 0.0,             size: 4, color: "#7c6af7", lag: 0.32 },
  { r: 13, speed: 1.1, phase: Math.PI,          size: 4, color: "#38bdf8", lag: 0.32 },
  { r: 20, speed: 0.65, phase: Math.PI / 3,     size: 3, color: "#a78bfa", lag: 0.26 },
  { r: 20, speed: 0.65, phase: Math.PI + Math.PI / 3, size: 3, color: "#38bdf8", lag: 0.26 },
  { r: 28, speed: 0.40, phase: Math.PI * 0.8,   size: 2, color: "#7c6af7", lag: 0.20 },
  { r: 28, speed: 0.40, phase: Math.PI * 1.8,   size: 2, color: "#a78bfa", lag: 0.20 },
];
...
export default function CustomCursor() {
  ...
  useEffect(() => {
    ...
    const tick = () => {
      ...
      /* Ring — lerp 0.38 */
      s.rx = lerp(s.rx, mx, 0.38);
      s.ry = lerp(s.ry, my, 0.38);
      if (ringRef.current) {
